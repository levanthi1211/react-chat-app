...
import { useEditSignature } from "./useEditSignature";
...
export const EditSignature: FC<EditSignatureProps> = (props) => {
  ...
  const { data, methods } = useEditSignature({ afterSubmit });
  const dispatch = useAppDispatch();

  const handleEditSignature = async (e: FormEvent) => {
    e.preventDefault();
    await methods.handleSubmitEditSignature();
