        ...
        <form onSubmit={handleSubmitForm} className="w-3/5" autoComplete="off">
          ...
          <div className="flex items-center mr-4 mb-2">
            <input
              ...
              w-4 h-4 border-3 border-slate-200 rounded focus:outline-0 focus:ring-0 focus:checked:bg-green-500 focus:ring-offset-0 checked:bg-green-500 checked:hover:bg-green-500"
            />
